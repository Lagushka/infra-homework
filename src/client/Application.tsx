    ...
    return <div className={bem()}>
        ...
        <nav className="navbar navbar-expand-sm navbar-light bg-light">
            <div className="container">
                <Link data-testid="main-link" className={bem('Brand', ['navbar-brand'])} to="/">Example store</Link>
                <button data-testid="burger-menu" className={bem('Toggler', ['navbar-toggler'])} aria-label="Toggle navigation" onClick={toggle}>
                    <span className="navbar-toggler-icon"></span>
                </button>
                <div data-testid="header-nav" id='headerMenu' className={bem('Menu', [navbarClass])}>
